...
export default function Banking() {
  return (
    <div className="container flex  items-end justify-evenly text-white bg-[#5BB5A2] mt-40 rounded-2xl">
      <div className="flex flex-col items-start justify-start gap-4 my-24">
        ...
        <div className="flex items-start justify-start">
          <Image src={apple} alt="apple and google icon"></Image>
        </div>
      </div>
      <div className="flex flex-col items-end justify-end">
        <Image src={card6} alt="mobile icon"></Image>
      </div>
    </div>
  );
}
